...
namespace AutoTanpopo
{
    ...
    public static class HotKeyManager
    {
        ...
        /// </summary>
        /// <param name="hWnd">A handle to the window that will receive <see cref="WindowMessages.HotKey"/> messages generated by the hot key.</param>
        /// <param name="key">The WPF virtual-key code of the hot key. See Virtual Key Codes.</param>
        /// <returns>-1 when failed to register hotkey, otherwise registered hotkey ID.</returns>
        public static int Register(IntPtr hWnd, Key key)
        {
            return Register(hWnd, ModifierKeys.None, (Keys)KeyInterop.VirtualKeyFromKey(key));
        }
        ...
        /// <param name="key">The WPF virtual-key code of the hot key. See Virtual Key Codes.</param>
        /// <returns>-1 when failed to register hotkey, otherwise registered hotkey ID.</returns>
        public static int Register(IntPtr hWnd, ModifierKeys modKey, Key key)
        {
            return Register(hWnd, modKey, (Keys)KeyInterop.VirtualKeyFromKey(key));
        }
