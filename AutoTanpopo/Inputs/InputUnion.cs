...
namespace AutoTanpopo.Inputs
{
    ...
    /// <para><see cref="KeyboardInput"/> supports nonkeyboard input methods, such as handwriting recognition or voice recognition, as if it were text input by using the <see cref="KeyEventFlags.Unicode"/> flag.
    ...
    public struct InputUnion
    {
        ...
        public static InputUnion CreateMouseInput(MouseEventFlags flags, int x = 0, int y = 0, int data = 0, int time = 0, IntPtr extraInfo = default)
        {
        ...
        public static InputUnion CreateKeyboardInput(KeyEventFlags flags, short virtualKey = 0, short scanCode = 0, int time = 0, IntPtr extraInfo = default)
        {
